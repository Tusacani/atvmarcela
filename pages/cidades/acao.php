<?php
    ...
    function editar(){
        ...
        $sql = "UPDATE cidade SET nome = '".$dados['nome']."', estado = '".$dados['estado']."' WHERE id = '".$dados['id']."';";
    ...
    function salvar(){
        ...
        $sql = "INSERT INTO cidade (id, nome, estado) VALUES ('".$dados['id']."','".$dados['nome']."','".$dados['estado']."')";
    ...
    function findById($id){
        $conexao = Conexao::getInstance();
        $conexao = $conexao->query("SELECT*FROM cidade WHERE id = $id;");
