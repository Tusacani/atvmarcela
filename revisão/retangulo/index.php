...
if ($id > 0){
    ...
    $qeditando = new Retangulo($dados[0]['idretangulo'],$dados[0]['base'],$dados[0]['altura'],$dados[0]['cor'],$dados[0]['un'],$dados[0]['idquadro']);
}
?>
...
<head>
    ...
    <title>Cadastro de Retângulos</title> <a href="../Quadro/index.php">Voltar</a>
    <style>
        .desenho{
...
<body>
    ...
    <section>
        <form action="acaoretangulo.php" method='post'>
            ...
            <input type="text" name='lado1' id='lado1' value='<?php if(isset($qeditando)) echo $qeditando->getLado2(); ?>'>
            <label for="lado2">Base:</label>
            <input type="text" name='lado2' id='lado2' value='<?php if(isset($qeditando)) echo $qeditando->getLado1(); ?>'>
